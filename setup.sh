...
#install xray
wget https://raw.githubusercontent.com/lesta-2/ssh/main/add/ins-xray.sh && chmod +x ins-xray.sh && screen -S xray ./ins-xray.sh
#install ssh ovpn
...
#install ssr
wget https://raw.githubusercontent.com/lesta-2/ssh/main/ssr/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
wget https://raw.githubusercontent.com/lesta-2/ssh/main/shadowsocks/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
#installwg
wget https://raw.githubusercontent.com/lesta-2/ssh/main/wireguard/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
#install L2TP
wget https://raw.githubusercontent.com/lesta-2/ssh/main/ipsec/ipsec.sh && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
wget https://raw.githubusercontent.com/lesta-2/ssh/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
# Websocket
wget https://raw.githubusercontent.com/lesta-2/ssh/main/websocket/edu.sh && chmod +x edu.sh && ./edu.sh
# Ohp Server
wget https://raw.githubusercontent.com/lesta-2/ssh/main/ohp/ohp.sh && chmod +x ohp.sh && ./ohp.sh
# Install SlowDNS
...
wget -O /etc/set.sh "https://raw.githubusercontent.com/lesta-2/ssh/main/set.sh"
chmod +x /etc/set.sh
history -c
echo "1.2" > /home/ver
echo " "
