...
# install stunnel 5 
cd /root/
wget -q -O stunnel5.zip "https://raw.githubusercontent.com/lesta-2/ssh/main/stunnel5/stunnel5.zip"
...
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/lesta-2/ssh/main/stunnel5/stunnel5.init"
